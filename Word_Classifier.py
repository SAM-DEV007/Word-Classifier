...
def download_model(id, destination):
    ...
    https://drive.google.com/file/d/1DevltQPYppcpk_83ZToJLia6_WVIOVno/view?usp=sharing
    '''
...
if __name__ == '__main__':
    ...
    if not os.path.exists(model_path):
        download_model('1DevltQPYppcpk_83ZToJLia6_WVIOVno', model_path)
    ...
    txt_arg = ["N/A", "Saying Hi", "Borrow Money"]
